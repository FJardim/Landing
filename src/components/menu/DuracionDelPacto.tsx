...
export default function DuracionDelPacto({
  contratoInfo,
  onChange,
  onSiguiente,
  onAnterior,
}: DuracionDelPactoProps) {
  return (
    <div className="bg-white rounded-lg p-4">
      <p className="text-base font-semibold pt-2">¿Duración del pacto?</p>
      <div className="pt-2 space-y-3">
        <input
          ...
          type="date"
          name="duracionPacto"
          value={contratoInfo.duracionPacto}
          onChange={onChange}
        />
      </div>
