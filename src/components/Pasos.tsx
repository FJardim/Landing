...
export default function Pasos() {
  return (
    <div className=' container bg-gray-200'>
        ...
        <CardInfo title={'1. Elegi un modelo'} text={'Podes elegir entre los 110 modelos disponibles'} icon= <SlDocs/> />
        <CardInfo title={'2. Completar el Documento'} text={'Podes elegir entre los 110 modelos disponibles'} icon= <PiNotePencil/> />
        <CardInfo title={'3. Guardar e Imprimir'} text={'Podes elegir entre los 110 modelos disponibles'} icon= <BsPrinter/> />
        </div>
